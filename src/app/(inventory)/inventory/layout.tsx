...
const inventoryNavItems = [
  { href: "/inventory", label: "Command Center", exact: true },
  { href: "/inventory/current", label: "Current Snapshot", exact: false },
  { href: "/inventory/incoming", label: "Incoming Supply", exact: false },
  { href: "/inventory/alerts-risks", label: "Alerts & Risks", exact: false },
  { href: "/inventory/health", label: "Health & Coverage", exact: false },
];
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fb]">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-40 -left-20 h-[400px] w-[400px] rounded-full bg-teal-200/12 blur-3xl" />
        <div className="absolute top-1/2 -right-20 h-[350px] w-[350px] rounded-full bg-cyan-200/12 blur-3xl" />
      </div>
      ...
      <main className="mx-auto max-w-[1600px] px-6 py-6">
        <nav className="mb-4 flex items-center gap-1.5 text-xs text-slate-500">
          ...
          <Link href="/inventory" className="hover:text-slate-700 transition-colors font-medium">Inventory</Link>
          {activeNavItem && activeNavItem.href !== "/inventory" && (
            <>
              <ChevronRight size={12} />
